...
async function main() {
  const service = read("lib/reporting/report-asset-service.ts"), previewRoute = read("app/api/reporting-groups/[groupId]/quarterly-reports/[reportId]/assets/preview/route.ts"), workspace = read("app/reporty/kvartalni/[groupId]/reporty/[reportId]/page.tsx") + read("components/quarterly-report-workspace/QuarterlyReportReviewExport.tsx");
