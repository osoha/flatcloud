...
function main() {
  ...
  check("trend renderer and selection data are unchanged", () => { assert.equal(digest(segment(renderer, "function Trends", "function AdditionalCommentary")), "c2c5ba45e04b337b5119419ee54533521d233a3b883a8e79de06f08f7e379df2"); assert.match(read("lib/reporting/presentation/quarterly-property-presentation-data.ts"), /where: \{ propertyId: input\.propertyId, quarterlyReport: \{ status: "PUBLISHED"/); });
