...
async function main() {
  const schema = read("lib/reporting/editorial-schema.ts"), service = read("lib/reporting/quarterly-report-service.ts"), workspace = read("app/reporty/kvartalni/[groupId]/reporty/[reportId]/page.tsx") + read("components/quarterly-report-workspace/QuarterlyReportPropertyWorkspace.tsx"), client = read("components/QuarterlyPropertyEditorialEditor.tsx");
