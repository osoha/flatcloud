...
async function main() {
  ...
  await check("no publish or correction UI is exposed", () => assert.doesNotMatch(workspace + client + editorialRoute + contentRoute, /publishQuarterlyReport|createCorrectionRevision|Publikovat|correction/));
