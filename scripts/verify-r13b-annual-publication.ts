...
await check("review completeness covers corporate, value, share and property layers", () => {
  const complete = {
    ...
    teamSnapshot: [{ sourceUserId: null, name: "Správce", role: "Řízení", email: "spravce@flatcloud.cz", photoDataUrl: null }],
    groupStructureSnapshot: { parent: { name: "FlatCloud a.s.", type: "holding", ico: "1", address: "Plzeň", leadership: "Správní rada" }, subsidiaries: [] },
    contactSnapshot: { companyName: "FlatCloud a.s.", registeredAddress: "Plzeň", officeAddress: "Plzeň", phone: "1", email: "info@flatcloud.cz", dataBox: "abc", boardMembers: "Správní rada", investmentCommittee: "Výbor", confidentialityNotice: "Důvěrné.", investmentDisclaimer: "Nejde o nabídku." },
    propertyReports: [{ propertyNameSnapshot: "Dům", openingValueCents: BigInt(1), currentValueCents: BigInt(1), targetValueCents: BigInt(1), investmentCase: "Případ", valueCreationNarrative: "Tvorba", outlook: "Výhled", sourceNote: "Zdroj", mapLatitude: 50, mapLongitude: 14 }],
  };
...
await check("annual PDF rendering is deterministic for identical frozen input", async () => {
  ...
  const data: FrozenAnnualReportPdfData = {
    reportingGroupName: "FlatCloud test", year: 2025, revision: 1, asOfDate: new Date("2025-12-31T23:00:00.000Z"), founderLetter: "Slovo zakladatele", executiveSummary: "Shrnutí", investmentThesis: "Teze", valueCreationSummary: "Tvorba hodnoty", outlook: "Výhled", grossAssetValueCents: BigInt(100000000), netAssetValueCents: BigInt(70000000), debtCents: BigInt(30000000), targetPortfolioValueCents: BigInt(120000000), realizedExitProceedsCents: BigInt(0), plannedExitProceedsCents: BigInt(15000000), issuedShares: 1000, treasuryShares: 10, sharePriceCents: BigInt(7000000), team: [], groupStructure: { parent: { name: "FlatCloud a.s.", type: "holding", ico: "", address: "", leadership: "" }, subsidiaries: [] }, contact: { companyName: "FlatCloud a.s.", registeredAddress: "", officeAddress: "", phone: "", email: "info@flatcloud.cz", dataBox: "", boardMembers: "", investmentCommittee: "", confidentialityNotice: "Důvěrný dokument.", investmentDisclaimer: "Nejde o veřejnou nabídku." }, properties: [{ propertyName: "Moskevská", propertyAddress: "Ústí nad Labem", openingValueCents: BigInt(50000000), currentValueCents: BigInt(60000000), targetValueCents: BigInt(75000000), realizedExitProceedsCents: BigInt(0), plannedExitProceedsCents: BigInt(0), plannedExitYear: 2027, investmentCase: "Investiční případ", valueCreationNarrative: "Tvorba hodnoty", outlook: "Milníky", sourceNote: "Interní valuace", mapLatitude: 50.66, mapLongitude: 14.04, mapLabel: "Moskevská", mapCardSide: "AUTO", mapPhotoDataUrl: null, snapshot: { revision: 1, source: "CALCULATED", schemaVersion: 1, calculatorVersion: "r13b-test", sourceNote: null, fingerprint: "a".repeat(64) } }],
  };
