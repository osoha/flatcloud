...
async function main() {
  ...
  await check("no trend, MF benchmark, or new narrative model was added", () => { const sources = schema + service + workspace; assert.doesNotMatch(sources, /MF benchmark|nextSteps|investmentThesis|customKpi|CAPEX commentary|shareholder return|trend calculation/i); assert.equal(hash("lib/reporting/editorial-schema.ts"), "1e79b34172eddba838e2bf2beb6ca2867f17ce8803b6f5e67a764294333c609c"); });
