...
function main() {
  ...
  check("ASSET background delivery and trend selection remain unchanged", () => { assert.equal(hash("app/api/reporting-groups/[groupId]/quarterly-reports/[reportId]/presentation/backgrounds/[role]/route.ts"), "722f0e768649e54eb454e897282ec92adbd346e9ec2845ebe889ab2b993a87aa"); assert.equal(hash("lib/reporting/presentation/quarterly-property-presentation-data.ts"), "b1fbec8cfbf4cff5c5e44d698a23773a5dfccfb4ff8557d04cb7a8f435d6a6a6"); });
  ...
  check("Prisma schema and migrations remain unchanged", () => assert.equal(hash("prisma/schema.prisma"), "3dc503357f5ec3b46698b762a98d4a834f0e578dbff59f47186aa8818c0d7390"));
