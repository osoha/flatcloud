...
async function main() {
  ...
  const workspace = read("app/reporty/kvartalni/[groupId]/reporty/[reportId]/page.tsx") + read("components/quarterly-report-workspace/QuarterlyReportReviewExport.tsx"), download = read("app/api/reporting-groups/[groupId]/quarterly-reports/[reportId]/assets/download/route.ts"), pkg = JSON.parse(read("package.json"));
