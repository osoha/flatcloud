...
export async function GET() {
  ...
  return json({ state: normalizeGuideState(row), capabilities: { hasProperties: Boolean(property), canAddTask: full || edits > 0,
