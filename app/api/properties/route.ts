...
export async function POST(request: Request) {
  ...
  try {
    ...
    const property = await prisma.property.create({ data: {
      ...
      ownerId, ownershipMode, communicationOwnerId, managerId,
    ...
    await audit(user.id, "PROPERTY_CREATED", "Property", property.id, { propertyCode: property.propertyCode, ownerId, ownershipMode, communicationOwnerId, managerId });
