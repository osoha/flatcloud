  ...
  const report = await prisma.quarterlyReport.findFirst({
    ...
    select: {
      ...
      propertyReports: { select: {
        ...
        media: { where: { role: "PRIMARY" }, select: { id: true, caption: true, sourceDocumentId: true }, take: 1 },
