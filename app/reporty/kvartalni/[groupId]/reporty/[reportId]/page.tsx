  ...
  const report = await prisma.quarterlyReport.findFirst({
    ...
    select: {
      ...
      propertyReports: { select: {
        id: true, propertyId: true, propertyNameSnapshot: true, propertyAddressSnapshot: true, propertyStatus: true, managementCommentary: true, technicalSections: true, valuationRows: true,
