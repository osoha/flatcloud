...
export const flatCloudQuarterly2026Config: ReportDesignTemplateConfig = reportDesignTemplateConfigSchema.parse({
  ...
  contentHeader: { preset: "FLATCLOUD_DIAGONAL_HEADER", height: 0.256, darkPolygon: [[0, 0], [0.655, 0], [0.635, 0.183], [0, 0.256]], lightPolygon: [[0.655, 0], [1, 0], [1, 0.139], [0.635, 0.183]], reportLabelRect: { x: 0.035, y: 0.04, width: 0.45, height: 0.04 }, propertyTitleRect: { x: 0.035, y: 0.085, width: 0.58, height: 0.08 }, logoRect: { x: 0.735, y: 0.025, width: 0.19, height: 0.075 } },
