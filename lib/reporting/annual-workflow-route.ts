...
const friendlyMessages = new Map([
  ...
  ["Annual report snapshot scope is inconsistent.", "Uložené stavy výročního reportu nejsou konzistentní."],
  ["Annual report snapshot source is invalid.", "Zdroj uloženého stavu výročního reportu není platný."],
