...
export function documentAccessWhere(user: User): Prisma.DocumentWhereInput { return { AND: [accessWhere(user), { OR: [{ taskEntryId: null }, { taskEntry: taskEntryVisibilityWhere(user) }] }] }; }
