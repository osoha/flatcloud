...
export const methodologyChapters: MethodologyChapter[] = [
  ...
  },
  {
    ...
    summary: "Jednotná evidence skutečných a plánovaných OPEX/CAPEX nákladů, jistiny, sazby a dluhové služby objektu.",
    audience: "Asset manager",
    steps: ["Oddělte provozní náklady OPEX od investic CAPEX.", "Rozlište plán, objednávku a skutečnost bez přepisování historie.", "U každého úvěru evidujte původní a aktuální jistinu, sazbu, fixaci a splatnost.", "Před reportem zkontrolujte úplnost období a aktuálnost zůstatků."],
