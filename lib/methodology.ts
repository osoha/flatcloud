...
export const methodologyChapters: MethodologyChapter[] = [
  {
    ...
    steps: [
      ...
      "Před přidáním záznamu ověřte jeho viditelnost. Interní poznámku vidí oprávnění účastníci a lidé s právem editace případu; zveřejnění vlastníkovi zvolte výslovně. Stejnou viditelnost mají přílohy.",
      ...
      "@all a @board jsou dvě označení stejné skupiny: všech aktuálních účastníků úkolu s přístupem k danému záznamu. Stačí napsat celý příkaz nebo jej vybrat po zadání @. Autor nedostává vlastní upozornění a více zmínek téže osoby vytvoří jedinou zprávu. Před odesláním vidíte počet adresně upozorněných lidí; skutečný e-mail respektuje jejich preference.",
      "Obecné, technické, revizní a běžné automatické úkoly mají jednoduchý komentář. U ručních úkolů k nájemnímu vztahu a u vymáhání navázaných na jednotku, nájemníka nebo smlouvu lze rozlišit poznámku, telefonát a e-mail. Příslib úhrady je dostupný pouze u otevřeného vymáhání; nenabízí se v revizích ani řízené CAPEX realizaci.",
      "Tlačítko Odpovědět přesune kurzor do editoru a označí autora, pokud je stále oprávněným účastníkem. Nový komentář zůstává ve společném vlákně. Přepínač Jen komentáře dočasně skryje systémové události a změny stavu.",
      "Chcete-li upozornit další účastníky, otevřete Upozornit a vyberte příjemce. Zprávu nejprve uložte do vlákna. Odeslání respektuje nastavení a aktuální přístup příjemce; výběr příjemce není potvrzení doručeného e-mailu.",
