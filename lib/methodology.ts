...
export const methodologyChapters: MethodologyChapter[] = [
  ...
  },
  {
    ...
    steps: ["V Reportech otevřete Valorizace a vyberte rozsah nemovitostí. Tento model pracuje s čistým nájemným bez služeb; MF je benchmark nájemného, nikoli prodejní hodnoty nemovitosti.", "Přepínač MF pouze skrývá nebo zobrazuje čárkovanou křivku; nemění výpočet. Křivka je dostupná při úplném pokrytí vybraných smluv. Kontrolujte období MF i konkrétní jednotky; bez podkladu nezaměňujte nájemné za tržní referenci.", "Roční růst trhu mění pouze budoucí MF křivku: výchozí MF × (1 + růst trhu) na počet dokončených let. Jde o váš odhad, nikoli prognózu MF. Konzervativní −1 %, základní 2 % a optimistický 4 % jsou upravitelné pracovní předpoklady.", "Roční růst nájmu a využití dnešního kladného MF rozdílu určují plán nezávisle na růstu trhu. Například nájem 10 000 Kč, MF 12 000 Kč, využití 50 %, doba 24 měsíců a nulový růst nájmu znamenají plán 10 500 Kč ve 12. měsíci a 11 000 Kč ve 24. měsíci. Růst trhu 2 % posune benchmark od 13. měsíce na 12 240 Kč. Nájem nad MF model automaticky nesnižuje.", "Tlačítkem Vlastní nastavte 1–360 měsíců nebo 1–30 let. Doba přiblížení k dnešnímu trhu je samostatný předpoklad, takže delší graf nemění první roky. Nad pět let lze přepínat měsíční body a roční přehled měsíčních částek. Dvacetiletá simulace je hrubý odhad, nikoli příslib výnosu.", "Náklady a úvěry: současný panel cashflow používá ručně zadané předpoklady. Automatické načítání známých nákladů jednotky a souvisejících úvěrů je navazující rozšíření. Chybějící údaj nepovažujte za nulový výdaj; domovní náklad potřebuje doložený podíl jednotky a nesmí se započítat znovu.", "Rozlišujte kladné měsíční cashflow, vyrovnání kumulovaného schodku a návratnost celé investice. Splátka jistiny je peněžní výdaj; neznamená stejný náklad při hodnocení zisku. Pro dlouhé období zvažte neobsazenost, opravy, refixaci a konec úvěru.", "Historické uložené scénáře zachovávají původní výpočet; nový model má samostatně uložené předpoklady trhu a doby přiblížení.", "Porovnejte současné smluvní nájemné s poslední dostupnou MF referencí; chybějící pokrytí nepovažujte za nulový potenciál.", "Přepněte konzervativní, základní a optimistický scénář a vždy čtěte jeho viditelné předpoklady růstu, vacancy, inkasa a využití tržního rozdílu.", "Pro pracovní citlivost upravte vlastní předpoklady. Přepočet mění pouze model a při změně horizontu musí zůstat hodnoty zachované.", "Ve smluvní křivce zkontrolujte nastavenou pevnou indexaci a expirace; po konci smlouvy tato křivka klesá na nulu.", "Uložte projednávanou variantu jako koncept; tím zmrazíte datum, rozsah, smluvní vstupy, vlastní předpoklady i MF referenci.", "Schválenou revizi používejte jako rozhodovací podklad. Další variantu zakládejte jako novou revizi, aby původní rozhodnutí zůstalo dohledatelné.", "Po schválení zkontrolujte dry-run náhled převodu. Rozlišuje návrhy k posouzení dodatku, smlouvy vyžadující nejprve obnovu, konflikt s indexací a jednotky beze změny; sám nic nezapisuje.", "Pro jednu způsobilou smlouvu připravte návrh změny, doplňte první den účinnosti a právní důvod. Na samostatné kontrolní obrazovce změnu potvrďte až po kontrole částky; potvrzení verzovaně změní nájemné a synchronizuje jen budoucí neuhrazené, automatické předpisy."],
