...
export const methodologyChapters: MethodologyChapter[] = [
  ...
  },
  {
    ...
    steps: ["Porovnejte současné smluvní nájemné s poslední dostupnou MF referencí; chybějící pokrytí nepovažujte za nulový potenciál.", "Přepněte konzervativní, základní a optimistický scénář a vždy čtěte jeho viditelné předpoklady růstu, vacancy, inkasa a využití tržního rozdílu.", "Ve smluvní křivce zkontrolujte nastavenou pevnou indexaci a expirace; po konci smlouvy tato křivka klesá na nulu.", "Uložte projednávanou variantu jako koncept; tím zmrazíte datum, rozsah, smluvní vstupy i MF referenci.", "Schválenou revizi používejte jako rozhodovací podklad. Další variantu zakládejte jako novou revizi, aby původní rozhodnutí zůstalo dohledatelné.", "Převod plánu do dodatku a budoucích předpisů je samostatný následný krok."],
    check: "Uložení ani schválení forecastu nesmí změnit smlouvu nebo předpis; každý scénář musí ukázat předpoklady, rozsah, datum vstupů a pokrytí MF dat.",
    href: "/reporty",
  },
  {
