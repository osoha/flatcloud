...
| B | IMPLEMENTED_PENDING_CI: schválená viditelnost historie/nových záznamů, společná autorizace příloh a ochrana návazných podkladů; samostatné PR a úplný gate. |
