...
| H | PR #95 merge `3ad0e58`, CI 97/97. OAuth, čtyři složky, H-01 upload/historie a uživatelem zobrazení PNG + PNG/PDF download GREEN. Samostatná UX oprava modálního náhledu s 3 UI regresemi je připravena pro celé CI. Živý file chooser blokuje H-02 náklad/error-retry; VIEW/EDIT/cizí scope a post-upload ancestry neověřené. H = IN_PROGRESS / LIVE_GATE_BLOCKED, nikoli hotový. Postup a důkazy v [bránách B/H](r24-storage-and-visibility-gates.md). |
