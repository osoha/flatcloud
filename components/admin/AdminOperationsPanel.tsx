...
export function AdminOperationsPanel({ initial }: { initial: Operations }) {
  ...
  return <section className="admin-operations-panel" aria-label="Provoz aplikace">
    ...
    <Link href="/uzivatele?activity=online#seznam-uzivatelu" title="Viditelná karta aplikace během posledních 2 minut"><span>Uživatelé online</span><b>{data.online}</b></Link>
