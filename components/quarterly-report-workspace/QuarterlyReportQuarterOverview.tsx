...
export function QuarterlyReportQuarterOverview({ year, quarter, groupName, revision, statusLabel, properties, quality, executiveSummaryEditor }: { year: number; quarter: number; groupName: string; revision: number; statusLabel: string; properties: QuarterlyPropertyNavItem[]; quality: QuarterlyQualityGateView; executiveSummaryEditor: ReactNode }) {
