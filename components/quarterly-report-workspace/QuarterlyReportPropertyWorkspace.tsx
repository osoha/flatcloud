...
import type { QuarterlyPropertyWorkspaceData, QuarterlySnapshotCandidate } from "./types";
...
export function QuarterlyReportPropertyWorkspace({ property, candidates, editable, baseAction, previous, next }: { property: QuarterlyPropertyWorkspaceData; candidates: QuarterlySnapshotCandidate[]; editable: boolean; baseAction: string; previous?: { id: string; name: string }; next?: { id: string; name: string } }) {
  const technicalSections = property.technicalSections || [];
  const valuationRows = property.valuationRows || [];
