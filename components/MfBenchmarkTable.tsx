...
export function MfBenchmarkTable({ properties, units, datasetAvailable = true }: { properties: PropertyRow[]; units: UnitRow[]; datasetAvailable?: boolean }) {
