...
type UnitRow = {
  ...
  category: MfRentCategoryKey;
  areaM2: number;
  actualRentPerM2Cents: number;
  marketRentPerM2Cents: number;
  marketGapPerM2Cents: number;
  rentToMarketBps: number | null;
  reversionaryPotentialCents: number;
};
